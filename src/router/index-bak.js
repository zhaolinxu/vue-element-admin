...
export const asyncRouterMap = [{
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'edit-form', component: _import('form/edit'), name: 'editForm', meta: { title: '其他产品'}}
    ]
  },
  {
    path: '/zip',
    ...
    children: [{ path: 'download', component: _import('zip/index'), name: 'exportZip', meta: { title: '意见反馈', icon: 'zip' }}]
  },

  {
    ...
    component: Layout,
    redirect: 'noredirect',
    children: [{ path: 'index', component: _import('theme/index'), name: 'theme', meta: { title: '我的账户', icon: 'theme' }}]
  },
